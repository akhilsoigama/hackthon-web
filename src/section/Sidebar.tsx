...
const Sidebar = () => {
  ...
  return (
    <motion.aside
      className="h-screen sticky top-0 flex flex-col transition-all duration-300 ease-in-out overflow-y-auto shadow-lg bg-white z-50"
      style={{ width: isSidebarExpanded ? (window.innerWidth >= 1024 ? '18rem' : '16rem') : (window.innerWidth >= 640 ? '5rem' : '4rem') }}
