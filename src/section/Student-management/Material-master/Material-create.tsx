      ...
      <div className="max-w-screen mx-auto">
        ...
        >
          ...
          <div className="bg-gradient-to-r from-blue-600 to-indigo-700 text-white p-6">
            <h1 className="text-3xl font-bold mb-2">Create New Material</h1>
            <p className="text-blue-100">{
              currentStep === 'details' 
                ? 'Fill in material details and upload PDFs' 
                : 'Review and submit your material'
            }</p>
              ...
              {currentStep === 'details' ? (
                ...
                >
                  ...
                  <div className="flex justify-between items-center pb-4 border-b">
                    <h2 className="text-2xl font-bold text-gray-800">Material Preview</h2>
                    <button
              ...
              {uploadProgress === 100 && (
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-sm text-green-600">Your material has been published successfully.</p>
                  </div>
                </motion.div>
              )}
            </AnimatePresence>
